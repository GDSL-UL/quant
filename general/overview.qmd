...
+==========+==============================================================+====================================+==========+
| 1        | Introduction                                                 | Lecture                            | ZY/RM    |
|          |                                                              |                                    |          |
|          | Getting Started in RStudio: Knowing Merseyside               | Computer Lab Practical             |          |
+----------+--------------------------------------------------------------+------------------------------------+----------+
...
Example datasets could be accessed through [ENVS 162 Canvas module](https://canvas.liverpool.ac.uk/courses/85565/modules) every week.
