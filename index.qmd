...
This is the website for "Human Geography through Merseyside - Quantitative Block: Seeing the world through numbers" (module **ENVS162**) at the University of Liverpool. This block of the module is designed and delivered by Dr. Zi Ye and Dr. Ron Mahabir from the Geographic Data Science Lab in the Department of Geography and Planning, at the University of Liverpool. The module seeks to provide hands-on experience and training in introductory statistics for human geographers.

The website is **free to use** and is licensed under the [Attribution-NonCommercial-NoDerivatives 4.0 International](https://creativecommons.org/licenses/by-nc-nd/4.0/). A compiled version of this web course is hosted as a GitHub repository that you can access:
