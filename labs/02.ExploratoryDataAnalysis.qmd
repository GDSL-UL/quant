...
As ever, when you start a new session in RStudio, you need to load the packages you wish to use into memory. In addition to the `tidyverse`, `tmap` and `sf` packages we used last week.
