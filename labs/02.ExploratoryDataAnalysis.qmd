...
```{r}
#make a map of constituency and color each polygon based on "region_name"
...
```{r}
#make a map for the pc_map_new, fill the colors for each polygon based on "first_party", using colors from palette "Set3"
