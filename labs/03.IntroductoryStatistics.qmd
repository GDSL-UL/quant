...
This is the 95% confidence interval, for the rest 2.5% in the lower tail and 2.5% in the upper tain. This is why you may find in the code, we use `qnorm(0.975)` as that refers to the cutoff points in two directions). Again, you may find your values subtly different due to random sample. But in my case, ***we are 95% confident that the mean household net income is between 13,315 pound and 23,002 pound***.
